      ...
      <div className="space-y-3">
        ...
        {discordSuccess || user?.discordLinked ? (
          <a
            ...
            className="flex items-center gap-1.5 px-1 pt-1 text-xs text-brand-grey/40 transition-colors hover:text-brand-grey"
          >
            ...
            discord connected{user?.discordUsername ? ` · @${user.discordUsername}` : ""}
          </a>
        ) : (
          <a
            href="/api/discord/oauth"
