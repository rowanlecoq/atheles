        ...
        {discordSuccess || user?.discordLinked ? (
          <div className="space-y-3">
            <div className="flex items-center gap-2 text-sm text-green-400">
              <span>●</span>
              <span>
                connected{user?.discordUsername ? ` as @${user.discordUsername}` : ""}
              </span>
            </div>
            <p className="text-xs text-brand-grey">
              Your rank role syncs automatically whenever your tier changes.
            </p>
            <a
          ...
          <>
            <p className="mb-4 text-sm text-brand-grey">
              Link your Discord to get your loyalty rank role synced automatically in our server.
            </p>
            <a
              href="/api/discord/oauth"
              className="inline-flex items-center gap-2 rounded-lg bg-[#5865F2]/20 px-4 py-2.5 text-sm text-[#7983F5] transition-colors hover:bg-[#5865F2]/30"
            >
