        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-sm rounded-xl border border-red-500/30 bg-brand-dark p-6 shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                type="button"
                disabled={updating === adminConfirm.member.id}
                onClick={() => {
                  updateTier(adminConfirm.member.id, adminConfirm.pendingTier);
                  setAdminConfirm(null);
                }}
                className="flex-1 rounded-lg bg-red-500/20 px-4 py-2 text-sm text-red-400 transition-colors hover:bg-red-500/30 disabled:opacity-50"
              >
                confirm admin
              </button>
            </div>
