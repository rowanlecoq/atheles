        ...
        <div className="w-full">
          ...
          <div className="rounded-lg border border-brand-dark-gold/20 bg-brand-dark p-8">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded border border-brand-dark-gold/30 bg-transparent px-6 py-3 text-sm text-white transition-colors hover:border-brand-gold hover:text-brand-gold"
            >
