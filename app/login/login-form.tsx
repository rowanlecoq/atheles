    ...
    <div className="mx-auto flex min-h-[60vh] max-w-md items-center px-4 py-10 sm:py-12">
      <div className="w-full">
        <div className="mb-8 text-center">
          <h1 className="mb-2 font-heading text-3xl text-brand-gold sm:text-4xl">sign in</h1>
        ...
        <div className="rounded-lg border border-brand-dark-gold/20 bg-brand-dark p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-brand-grey">
              ...
              <Link href="/register" className="text-brand-gold underline underline-offset-4 hover:text-brand-light-gold">create one</Link>
            </p>
          </div>
        </div>
      </div>
