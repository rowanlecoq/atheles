...
export function AnnouncementBar() {
  ...
  return (
    <div className={`announcement-bar-root flex h-8 items-center overflow-hidden border-b border-brand-dark-gold/20 bg-brand-dark/95 ${entered ? "animate-announcement-bar-enter" : "navbar-pre-enter"}`}>
