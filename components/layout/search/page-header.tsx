...
export default function SearchPageHeader() {
  ...
  return (
    <div className="relative overflow-hidden border-b border-brand-dark-gold/20 bg-brand-dark" style={{ minHeight: 168 }}>
      ...
      {/* Content */}
      <div className="relative px-4 pb-8 pt-10 sm:pb-10 sm:pt-14" style={{ paddingTop: 56, paddingBottom: 40 }}>
