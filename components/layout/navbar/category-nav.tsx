...
export function CategoryNav() {
  ...
  return (
    <div className="relative hidden md:block">
      {/*
        Wrap only the nav bar in the overflow-hidden/max-height container.
        This smoothly collapses/expands the bar without a sudden layout shift,
        and avoids clipping the absolutely-positioned dropdown panels.
      */}
      <div
        style={{
          maxHeight: isHomepage ? 0 : 60,
          overflow: "hidden",
          transition: "max-height 0.22s cubic-bezier(0.25, 0.1, 0.25, 1)",
        }}
      >
      ...
      {/* Dropdown panels — absolutely positioned, outside overflow-hidden so they aren't clipped */}
      {!isHomepage &&
        categories
